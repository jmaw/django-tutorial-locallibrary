...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        help_text="Ingrese el nombre del género(p. ej. Ciencia Ficción, \
                  Poesía Francesa etc.)",
    )
...
class Book(models.Model):
    ...
    # 'Author' es un string, en vez de un objeto, porque la clase Author
    ...
    isbn = models.CharField(
        "ISBN",
        max_length=13,
        help_text='13 Caracteres <a href="https://www.isbn-international.org/\
    ...
    # ManyToManyField, porque un género puede contener muchos libros
    # y un libro puede cubrir varios géneros.
    # La clase Genre ya ha sido definida, entonces podemos especificar
    # el objeto arriba.
